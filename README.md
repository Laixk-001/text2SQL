...
```shell
CUDA_VISIBLE_DEVICES=0,1 deepspeed --master_port 5545 train_qwen.py --train_path /root/autodl-tmp/data/DuSQL/text2sql_train_zh.json  \
                                                                   --test_path /root/autodl-tmp/data/DuSQL/text2sql_dev_zh.json  \
