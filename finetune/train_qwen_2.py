...
def train():
    ...
    # 数据配置
    parser.add_argument("--train_path",default="/root/autodl-fs/DuSQL/text2sql_train_tokenizer_zh.json",type=str,help="",nargs="?")
    parser.add_argument("--test_path",default="/root/autodl-fs/DuSQL/text2sql_train_tokenizer_zh.json",type=str,help="",nargs="?")
    ...
    parser.add_argument("--weight_decay",default=0.1,type=float,help="",nargs="?")
    parser.add_argument("--num_train_epochs",default=1,type=int,help="",nargs="?")
    parser.add_argument("--gradient_accumulation_steps",default=1,type=int,help="",nargs="?")
    ...
    parser.add_argument("--local_rank", type=str, default="0,1", help="",nargs="?")
    ...
    # QLoRA配置
    parser.add_argument("--lora_dim", type=int, default=8, help="",nargs="?")
    parser.add_argument("--lora_alpha", type=int, default=30, help="",nargs="?")
    parser.add_argument("--lora_dropout", type=float, default=0.1, help="",nargs="?")
